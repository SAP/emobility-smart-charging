...
public class PerformanceMeasurementPaperJournal2018WeightCombinations extends PerformanceMeasurement<PerformanceMeasurementPaperJournal2018WeightCombinations> {
	...
	public PerformanceMeasurementPaperJournal2018WeightCombinations(int nCars, int nChargingStations, double randomness, String methodDayahead, String methodRealtime, 
	...
	public PerformanceMeasurementPaperJournal2018WeightCombinations(String guid, String filePath, String method, int nCars, int nChargingStations, double randomness, String methodDayahead, String methodRealtime, 
			double weightFairShare, double weightCosts, double weightPeakShaving, double weightLoadImbalance, int seed) {
	...
	@Override
	public PerformanceMeasurementPaperJournal2018WeightCombinations cloneWithMethod(String method) {
		String guid = Util.generateGUID();
		String filePath = "gen/performance/" + guid + ".json";
		return new PerformanceMeasurementPaperJournal2018WeightCombinations(guid, filePath, method, nCars, nChargingStations, randomness, methodDayahead, methodRealtime, weightFairShare, weightCosts, weightPeakShaving, weightLoadImbalance, seed);
	}

	@Override
	public String getTableName() {
		return "performanceMeasurementsPaperJournal2018WeightCombinations";
	}
