...
public class MeasurementExecutorForecasting2018_11 	
	extends MeasurementExecutor<PerformanceMeasurementForecasting2018_11> {

		public MeasurementExecutorForecasting2018_11(SQLiteDB db) {
			super(db);
		}
		public MeasurementExecutorForecasting2018_11(SQLiteDB db, boolean forceMeasurement) {
			super(db, forceMeasurement);
		}
		
		@Override
		public void accept(PerformanceMeasurementForecasting2018_11 measurement) {
			...
			PerformanceMeasurementForecasting2018_11 measurementHeuristic = measurement.cloneWithMethod(StrategyAlgorithmic.getMethodWithoutScheduleStatic());
